...
(function () {
  ...
  //
  // Extending this: add another entry to flowscratch-tutorials.js with its own
  ...
  // ============================================================
  // The tutorial list itself lives in flowscratch-tutorials.js, loaded just
  ...
  if (!window.FlowScratchContent) console.warn('FlowScratch: flowscratch-tutorials.js did not load; tutorials unavailable.');
  var FS_TUTORIALS = window.FlowScratchContent ? window.FlowScratchContent.TUTORIALS : [];
